...
import { AppSpinnerComponent } from "./components/core/controls/app-spinner/app-spinner.component";

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, ButtonModule, MainInterfaceComponent, ToastModule, AppDialogComponent, AppSpinnerComponent],
